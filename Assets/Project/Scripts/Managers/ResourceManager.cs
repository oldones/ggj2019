...
public class ResourceManager : MonoBehaviour
{
    ...
    [SerializeField] float HighSpeedFuelConsumptionFactor = 4;
    [SerializeField] float NormalSpeedFuelConsumptionFactor = 1;
    [SerializeField] float LowSpeedFuelConsumptionFactor = 0.25f;
